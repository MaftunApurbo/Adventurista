...
public class Home extends JFrame implements ActionListener{
    String username;
    JButton notepad,deletePersonalDetails,calculators,addPersonalDetails,payments,viewbookedhotel,bookhotels,destinations,viewhotels,viewpackages, bookpackages,viewPersonalDetails,updatePersonalDetails,checkpackages;
    Home(String username){
        ...
        text.setFont(new Font("Tahoma",Font.TRUETYPE_FONT,55));
        image.add(text);
